...
@Model(adaptables = SlingHttpServletRequest.class, adapters = StaticContentImagesModel.class, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
public class StaticContentImagesModel {
