...
public class DestinationLandingPageEditorialArticals {

    private static final Logger logger = LoggerFactory.getLogger(DestinationLandingPageEditorialArticals.class);
